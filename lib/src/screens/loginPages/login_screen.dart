...
import 'package:halfwaynew/src/constants/custom_colors.dart';
import 'package:halfwaynew/src/screens/loginPages/signin.dart';
import 'package:halfwaynew/src/utils/toast_helper.dart';
import 'package:halfwaynew/src/viwModel/login_provider.dart';
  ...
  _googleLogin(BuildContext context) async {
    ...
    if (response) {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, MyRouters.mapplsScreen, (route) => false);
    } else {
