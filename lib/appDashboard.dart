    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color:
                                      const Color.fromARGB(255, 165, 177, 165),
          ...
          //                   ),
          //                 ],
          //                 color: const Color.fromARGB(255, 165, 177, 165),
          //               ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => OfflineMaps()),
                      );
                    },
                    child: Container(
                      width: 320,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => SpacialAudio()),
                      );
                    },
                    child: Container(
                      width: 320,
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => RasterLayers()),
                      );
                    },
                    child: Container(
                      width: 320,
